...
function Footer() {
  ...
  return (
    <footer className="footer p-10 bg-gradient-to-r from-primary to-secondary text-base-content mt-10">
      <div>
        <span className="footer-title text-white">Rental</span>
        {categorys.map((category) => (
          <Link key={category._id} className="link link-hover text-white">
            {category.category}
          </Link>
        ))}
        {/* 
      ...
      <div>
        ...
        <Link to="/aboutus" className="link link-hover text-white">
          About us
        </Link>
        <Link to="/aboutus" className="link link-hover text-white">
          Contact
