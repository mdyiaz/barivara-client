...
import {GiFamilyHouse, GiLighthouse, GiVikingLonghouse, GiMushroomHouse} from "react-icons/gi"
          ...
          <div className="grid grid-cols-3 gap-8 ">
              {
                categorys.map(category => 
                  <div className="flex flex-col items-center">
                    ...
                    <p className="mt-3 text-base font-bold text-gray-700 hover:text-teal-600">{category.category}</p>
                  </div>
